...
The lab also shows three separate **chronological consistency segments** with independent simulated starting balances and one frozen rule. The segments are a descriptive check of variation across time, not extra untouched holdouts, independent market samples or predictive validation.
